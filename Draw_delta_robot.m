...
line([p2(1),p21(1)],[p2(2),p21(2)],[p2(3),p21(3)],  'LineWidth',5,'Color',[0.0,0.0,0.6],'Marker','.','MarkerSize',1);%Rieles
line([p3(1),p31(1)],[p3(2),p31(2)],[p3(3),p31(3)],  'LineWidth',5,'Color',[0.0,0.0,0.6],'Marker','.','MarkerSize',1);
line([p4(1),p41(1)],[p4(2),p41(2)],[p4(3),p41(3)],  'LineWidth',5,'Color',[0.0,0.0,0.6],'Marker','.','MarkerSize',1);

line([p22(1),p23(1)],[p22(2),p23(2)],[p22(3),p23(3)],  'LineWidth',3,'Color',[0.0,0.8,0.0],'Marker','.','MarkerSize',4); %Brazos Esalbones
line([p32(1),p33(1)],[p32(2),p33(2)],[p32(3),p33(3)],  'LineWidth',3,'Color',[0.0,0.8,0.0],'Marker','.','MarkerSize',4);
line([p42(1),p43(1)],[p42(2),p43(2)],[p42(3),p43(3)],  'LineWidth',3,'Color',[0.0,0.8,0.0],'Marker','.','MarkerSize',4);
...
set(movil, 'EdgeColor', [0.0,0.0,0.4],'LineWidth',5);
grid on
view([90,90, 90 ])
